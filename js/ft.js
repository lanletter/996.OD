...
ft.purchase = function (option,fn) {
    ...
    purchaseConfig.param.title = option.title ||"" ;
    purchaseConfig.param.imagePath = option.imagePath ||"" ;
    purchaseConfig.param.oldPrice = option.oldPrice ||"" ;
    purchaseConfig.param.newPrice = option.newPrice ||"" ;
    purchaseConfig.param.number = option.number ||"";
    purchaseConfig.param.statsTime = option.statsTime ||"";
    purchaseConfig.param.address = option.address ||"" ;
    purchaseConfig.param.voucherNumber = option.voucherNumber ||"" ;
    purchaseConfig.param.productId = option.productId ||"" ;
